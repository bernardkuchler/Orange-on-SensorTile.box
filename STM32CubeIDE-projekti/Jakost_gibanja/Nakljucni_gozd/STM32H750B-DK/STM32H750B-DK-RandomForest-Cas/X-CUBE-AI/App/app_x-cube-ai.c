...
AI_ALIGNED(4) ai_i8 data_in_1[AI_RANDOMFOREST_IN_1_SIZE_BYTES];
ai_i8* data_ins[AI_RANDOMFOREST_IN_NUM] = {
data_in_1
};
#else
ai_i8* data_ins[AI_RANDOMFOREST_IN_NUM] = {
...
AI_ALIGNED(4) ai_i8 data_out_1[AI_RANDOMFOREST_OUT_1_SIZE_BYTES];
AI_ALIGNED(4) ai_i8 data_out_2[AI_RANDOMFOREST_OUT_2_SIZE_BYTES];
ai_i8* data_outs[AI_RANDOMFOREST_OUT_NUM] = {
data_out_1,
data_out_2
};
#else
...
AI_ALIGNED(32)
static uint8_t pool0[AI_RANDOMFOREST_DATA_ACTIVATION_1_SIZE];

ai_handle data_activations0[] = {pool0};

/* AI objects ----------------------------------------------------------------*/

static ai_handle randomforest = AI_HANDLE_NULL;
