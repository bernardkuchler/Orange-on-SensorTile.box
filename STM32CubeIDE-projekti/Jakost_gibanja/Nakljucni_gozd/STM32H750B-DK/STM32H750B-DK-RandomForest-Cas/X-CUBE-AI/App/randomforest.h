...
#define AI_RANDOMFOREST_ORIGIN_MODEL_NAME   "nakljucni_gozdjakost_gibanjaonnx"
...
#define AI_RANDOMFOREST_IN_1_CHANNEL     (1)
#define AI_RANDOMFOREST_IN_1_SIZE        (1 * 1)
#define AI_RANDOMFOREST_IN_1_SIZE_BYTES  (4)
...
#define AI_RANDOMFOREST_OUT_2_WIDTH       (3)
#define AI_RANDOMFOREST_OUT_2_CHANNEL     (2)
#define AI_RANDOMFOREST_OUT_2_SIZE        (1 * 3 * 2)
#define AI_RANDOMFOREST_OUT_2_SIZE_BYTES  (24)
