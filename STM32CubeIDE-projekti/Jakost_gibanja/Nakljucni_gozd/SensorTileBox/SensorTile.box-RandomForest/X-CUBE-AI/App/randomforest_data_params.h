...
#define AI_RANDOMFOREST_DATA_ACTIVATIONS_SIZES \
  { 40, }
#define AI_RANDOMFOREST_DATA_ACTIVATIONS_SIZE     (40)
#define AI_RANDOMFOREST_DATA_ACTIVATIONS_COUNT    (1)
#define AI_RANDOMFOREST_DATA_ACTIVATION_1_SIZE    (40)



#define AI_RANDOMFOREST_DATA_WEIGHTS_SIZES \
  { 1268, }
#define AI_RANDOMFOREST_DATA_WEIGHTS_SIZE         (1268)
#define AI_RANDOMFOREST_DATA_WEIGHTS_COUNT        (1)
#define AI_RANDOMFOREST_DATA_WEIGHT_1_SIZE        (1268)
