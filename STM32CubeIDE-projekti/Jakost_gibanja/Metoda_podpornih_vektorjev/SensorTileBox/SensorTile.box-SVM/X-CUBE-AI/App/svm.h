...
/******************************************************************************/
#define AI_SVM_MODEL_NAME          "svm"
#define AI_SVM_ORIGIN_MODEL_NAME   "metoda_podpornih_vektorjevjakost_gibanjaonnx"

/******************************************************************************/
#define AI_SVM_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SVM_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SVM_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SVM_IN_NUM        (1)

AI_DEPRECATED
#define AI_SVM_IN \
  ai_svm_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SVM_IN_SIZE { \
  AI_SVM_IN_1_SIZE, \
}
#define AI_SVM_IN_SIZE_BYTES { \
  AI_SVM_IN_1_SIZE_BYTES, \
}
#define AI_SVM_IN_1_CHANNEL     (1)
#define AI_SVM_IN_1_SIZE        (1)
#define AI_SVM_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_SVM_OUT_NUM       (2)

AI_DEPRECATED
#define AI_SVM_OUT \
  ai_svm_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SVM_OUT_SIZE { \
  AI_SVM_OUT_1_SIZE, \
  AI_SVM_OUT_2_SIZE, \
}
#define AI_SVM_OUT_SIZE_BYTES { \
  AI_SVM_OUT_1_SIZE_BYTES, \
  AI_SVM_OUT_2_SIZE_BYTES, \
}
#define AI_SVM_OUT_1_CHANNEL     (1)
#define AI_SVM_OUT_1_SIZE        (1)
#define AI_SVM_OUT_1_SIZE_BYTES  (4)
#define AI_SVM_OUT_2_HEIGHT      (1)
#define AI_SVM_OUT_2_WIDTH       (3)
#define AI_SVM_OUT_2_CHANNEL     (2)
#define AI_SVM_OUT_2_SIZE        (1 * 3 * 2)
#define AI_SVM_OUT_2_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_SVM_N_NODES (3)
 ...
 * @ref ai_svm_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_SVM_*
 * defines into file @ref svm.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
