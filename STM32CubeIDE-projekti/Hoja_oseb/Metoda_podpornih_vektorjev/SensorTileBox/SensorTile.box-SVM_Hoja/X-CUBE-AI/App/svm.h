...
#define AI_SVM_ORIGIN_MODEL_NAME   "metoda_podpornih_vektorjevhojaosebonnx"
...
#define AI_SVM_IN_1_CHANNEL     (16)
#define AI_SVM_IN_1_SIZE        (16)
#define AI_SVM_IN_1_SIZE_BYTES  (64)
...
#define AI_SVM_OUT_2_WIDTH       (5)
#define AI_SVM_OUT_2_CHANNEL     (2)
#define AI_SVM_OUT_2_SIZE        (1 * 5 * 2)
#define AI_SVM_OUT_2_SIZE_BYTES  (40)
