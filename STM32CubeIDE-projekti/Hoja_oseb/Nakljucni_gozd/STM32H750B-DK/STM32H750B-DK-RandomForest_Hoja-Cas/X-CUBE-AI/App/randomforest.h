...
#ifndef AI_RANDOMFOREST_H
#define AI_RANDOMFOREST_H
#pragma once
...
/******************************************************************************/
#define AI_RANDOMFOREST_MODEL_NAME          "randomforest"
#define AI_RANDOMFOREST_ORIGIN_MODEL_NAME   "nakljucni_gozdhoja_osebonnx"

/******************************************************************************/
#define AI_RANDOMFOREST_ACTIVATIONS_ALIGNMENT   (4)
#define AI_RANDOMFOREST_INPUTS_IN_ACTIVATIONS   (4)
#define AI_RANDOMFOREST_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_RANDOMFOREST_IN_NUM        (1)

AI_DEPRECATED
#define AI_RANDOMFOREST_IN \
  ai_randomforest_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_RANDOMFOREST_IN_SIZE { \
  AI_RANDOMFOREST_IN_1_SIZE, \
}
#define AI_RANDOMFOREST_IN_SIZE_BYTES { \
  AI_RANDOMFOREST_IN_1_SIZE_BYTES, \
}
#define AI_RANDOMFOREST_IN_1_HEIGHT      (1)
#define AI_RANDOMFOREST_IN_1_CHANNEL     (16)
#define AI_RANDOMFOREST_IN_1_SIZE        (1 * 16)
#define AI_RANDOMFOREST_IN_1_SIZE_BYTES  (64)

/******************************************************************************/
#define AI_RANDOMFOREST_OUT_NUM       (2)

AI_DEPRECATED
#define AI_RANDOMFOREST_OUT \
  ai_randomforest_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_RANDOMFOREST_OUT_SIZE { \
  AI_RANDOMFOREST_OUT_1_SIZE, \
  AI_RANDOMFOREST_OUT_2_SIZE, \
}
#define AI_RANDOMFOREST_OUT_SIZE_BYTES { \
  AI_RANDOMFOREST_OUT_1_SIZE_BYTES, \
  AI_RANDOMFOREST_OUT_2_SIZE_BYTES, \
}
#define AI_RANDOMFOREST_OUT_1_CHANNEL     (1)
#define AI_RANDOMFOREST_OUT_1_SIZE        (1)
#define AI_RANDOMFOREST_OUT_1_SIZE_BYTES  (4)
#define AI_RANDOMFOREST_OUT_2_HEIGHT      (1)
#define AI_RANDOMFOREST_OUT_2_WIDTH       (5)
#define AI_RANDOMFOREST_OUT_2_CHANNEL     (2)
#define AI_RANDOMFOREST_OUT_2_SIZE        (1 * 5 * 2)
#define AI_RANDOMFOREST_OUT_2_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_RANDOMFOREST_N_NODES (2)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup randomforest
 ...
 * @ref ai_randomforest_create. Both the activations memory buffer 
 ...
 * using @ref ai_randomforest_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_randomforest_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_randomforest_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_RANDOMFOREST_*
 * defines into file @ref randomforest.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_randomforest_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_RANDOMFOREST_H */
