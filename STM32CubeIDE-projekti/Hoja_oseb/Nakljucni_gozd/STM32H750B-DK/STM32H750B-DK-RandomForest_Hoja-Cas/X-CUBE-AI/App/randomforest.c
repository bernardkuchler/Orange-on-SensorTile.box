...
#define AI_RANDOMFOREST_MODEL_SIGNATURE     "50f9c86336850d9ee75ff6e1689b3585"
...
#define AI_TOOLS_DATE_TIME   "Wed Jul 12 11:27:34 2023"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 1, 6940, 1, 1), AI_STRIDE_INIT(4, 2, 2, 13880, 13880),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  5, 0x0,
  AI_SHAPE_INIT(4, 1, 17, 1, 1), AI_STRIDE_INIT(4, 2, 2, 34, 34),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  6, 0x0,
  AI_SHAPE_INIT(4, 1, 2759, 1, 1), AI_STRIDE_INIT(4, 1, 1, 2759, 2759),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  8, 0x0,
  AI_SHAPE_INIT(4, 1, 2759, 1, 1), AI_STRIDE_INIT(4, 4, 4, 11036, 11036),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  10, 0x0,
  AI_SHAPE_INIT(4, 1, 2759, 1, 1), AI_STRIDE_INIT(4, 2, 2, 5518, 5518),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  14, 0x0,
  AI_SHAPE_INIT(4, 1, 6940, 1, 1), AI_STRIDE_INIT(4, 4, 4, 27760, 27760),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 80496, 1, 1),
    80496, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 88, 1, 1),
    88, NULL, NULL),
