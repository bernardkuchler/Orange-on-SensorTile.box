/**
  ******************************************************************************
  * @file    randomforestjakostgibanja.h
...
#ifndef AI_RANDOMFORESTJAKOSTGIBANJA_H
#define AI_RANDOMFORESTJAKOSTGIBANJA_H
#pragma once
...
/******************************************************************************/
#define AI_RANDOMFORESTJAKOSTGIBANJA_MODEL_NAME          "randomforestjakostgibanja"
#define AI_RANDOMFORESTJAKOSTGIBANJA_ORIGIN_MODEL_NAME   "orangerandomforestnumericalclassvonnxformatu"

/******************************************************************************/
#define AI_RANDOMFORESTJAKOSTGIBANJA_ACTIVATIONS_ALIGNMENT   (4)
#define AI_RANDOMFORESTJAKOSTGIBANJA_INPUTS_IN_ACTIVATIONS   (4)
#define AI_RANDOMFORESTJAKOSTGIBANJA_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_RANDOMFORESTJAKOSTGIBANJA_IN_NUM        (1)

AI_DEPRECATED
#define AI_RANDOMFORESTJAKOSTGIBANJA_IN \
  ai_randomforestjakostgibanja_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_RANDOMFORESTJAKOSTGIBANJA_IN_SIZE { \
  AI_RANDOMFORESTJAKOSTGIBANJA_IN_1_SIZE, \
}
#define AI_RANDOMFORESTJAKOSTGIBANJA_IN_SIZE_BYTES { \
  AI_RANDOMFORESTJAKOSTGIBANJA_IN_1_SIZE_BYTES, \
}
#define AI_RANDOMFORESTJAKOSTGIBANJA_IN_1_HEIGHT      (1)
#define AI_RANDOMFORESTJAKOSTGIBANJA_IN_1_CHANNEL     (1)
#define AI_RANDOMFORESTJAKOSTGIBANJA_IN_1_SIZE        (1 * 1)
#define AI_RANDOMFORESTJAKOSTGIBANJA_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_RANDOMFORESTJAKOSTGIBANJA_OUT_NUM       (2)

AI_DEPRECATED
#define AI_RANDOMFORESTJAKOSTGIBANJA_OUT \
  ai_randomforestjakostgibanja_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_RANDOMFORESTJAKOSTGIBANJA_OUT_SIZE { \
  AI_RANDOMFORESTJAKOSTGIBANJA_OUT_1_SIZE, \
  AI_RANDOMFORESTJAKOSTGIBANJA_OUT_2_SIZE, \
}
#define AI_RANDOMFORESTJAKOSTGIBANJA_OUT_SIZE_BYTES { \
  AI_RANDOMFORESTJAKOSTGIBANJA_OUT_1_SIZE_BYTES, \
  AI_RANDOMFORESTJAKOSTGIBANJA_OUT_2_SIZE_BYTES, \
}
#define AI_RANDOMFORESTJAKOSTGIBANJA_OUT_1_CHANNEL     (1)
#define AI_RANDOMFORESTJAKOSTGIBANJA_OUT_1_SIZE        (1)
#define AI_RANDOMFORESTJAKOSTGIBANJA_OUT_1_SIZE_BYTES  (4)
#define AI_RANDOMFORESTJAKOSTGIBANJA_OUT_2_HEIGHT      (1)
#define AI_RANDOMFORESTJAKOSTGIBANJA_OUT_2_WIDTH       (3)
#define AI_RANDOMFORESTJAKOSTGIBANJA_OUT_2_CHANNEL     (2)
#define AI_RANDOMFORESTJAKOSTGIBANJA_OUT_2_SIZE        (1 * 3 * 2)
#define AI_RANDOMFORESTJAKOSTGIBANJA_OUT_2_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_RANDOMFORESTJAKOSTGIBANJA_N_NODES (2)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup randomforestjakostgibanja
 ...
 * @ingroup randomforestjakostgibanja
 ...
 * @ref ai_randomforestjakostgibanja_create. Both the activations memory buffer 
 ...
 * using @ref ai_randomforestjakostgibanja_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_randomforestjakostgibanja_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_randomforestjakostgibanja_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_RANDOMFORESTJAKOSTGIBANJA_*
 * defines into file @ref randomforestjakostgibanja.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_randomforestjakostgibanja_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_RANDOMFORESTJAKOSTGIBANJA_H */
