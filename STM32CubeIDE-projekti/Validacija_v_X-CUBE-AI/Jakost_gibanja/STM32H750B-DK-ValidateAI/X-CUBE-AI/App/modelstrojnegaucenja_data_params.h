...
#define AI_MODELSTROJNEGAUCENJA_DATA_ACTIVATIONS_SIZES \
  { 648, }
#define AI_MODELSTROJNEGAUCENJA_DATA_ACTIVATIONS_SIZE     (648)
#define AI_MODELSTROJNEGAUCENJA_DATA_ACTIVATIONS_COUNT    (1)
#define AI_MODELSTROJNEGAUCENJA_DATA_ACTIVATION_1_SIZE    (648)



#define AI_MODELSTROJNEGAUCENJA_DATA_WEIGHTS_SIZES \
  { 1644, }
#define AI_MODELSTROJNEGAUCENJA_DATA_WEIGHTS_SIZE         (1644)
#define AI_MODELSTROJNEGAUCENJA_DATA_WEIGHTS_COUNT        (1)
#define AI_MODELSTROJNEGAUCENJA_DATA_WEIGHT_1_SIZE        (1644)
