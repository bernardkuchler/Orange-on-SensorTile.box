/**
  ******************************************************************************
  * @file    modelstrojnegaucenja.h
  * @author  AST Embedded Analytics Research Platform
  * @date    Wed Jul 12 15:49:18 2023
...
#ifndef AI_MODELSTROJNEGAUCENJA_H
#define AI_MODELSTROJNEGAUCENJA_H
#pragma once
...
/******************************************************************************/
#define AI_MODELSTROJNEGAUCENJA_MODEL_NAME          "modelstrojnegaucenja"
#define AI_MODELSTROJNEGAUCENJA_ORIGIN_MODEL_NAME   "metoda_podpornih_vektorjevjakost_gibanjaonnx"

/******************************************************************************/
#define AI_MODELSTROJNEGAUCENJA_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MODELSTROJNEGAUCENJA_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MODELSTROJNEGAUCENJA_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MODELSTROJNEGAUCENJA_IN_NUM        (1)

AI_DEPRECATED
#define AI_MODELSTROJNEGAUCENJA_IN \
  ai_modelstrojnegaucenja_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODELSTROJNEGAUCENJA_IN_SIZE { \
  AI_MODELSTROJNEGAUCENJA_IN_1_SIZE, \
}
#define AI_MODELSTROJNEGAUCENJA_IN_SIZE_BYTES { \
  AI_MODELSTROJNEGAUCENJA_IN_1_SIZE_BYTES, \
}
#define AI_MODELSTROJNEGAUCENJA_IN_1_CHANNEL     (1)
#define AI_MODELSTROJNEGAUCENJA_IN_1_SIZE        (1)
#define AI_MODELSTROJNEGAUCENJA_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_MODELSTROJNEGAUCENJA_OUT_NUM       (2)

AI_DEPRECATED
#define AI_MODELSTROJNEGAUCENJA_OUT \
  ai_modelstrojnegaucenja_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODELSTROJNEGAUCENJA_OUT_SIZE { \
  AI_MODELSTROJNEGAUCENJA_OUT_1_SIZE, \
  AI_MODELSTROJNEGAUCENJA_OUT_2_SIZE, \
}
#define AI_MODELSTROJNEGAUCENJA_OUT_SIZE_BYTES { \
  AI_MODELSTROJNEGAUCENJA_OUT_1_SIZE_BYTES, \
  AI_MODELSTROJNEGAUCENJA_OUT_2_SIZE_BYTES, \
}
#define AI_MODELSTROJNEGAUCENJA_OUT_1_CHANNEL     (1)
#define AI_MODELSTROJNEGAUCENJA_OUT_1_SIZE        (1)
#define AI_MODELSTROJNEGAUCENJA_OUT_1_SIZE_BYTES  (4)
#define AI_MODELSTROJNEGAUCENJA_OUT_2_HEIGHT      (1)
#define AI_MODELSTROJNEGAUCENJA_OUT_2_WIDTH       (3)
#define AI_MODELSTROJNEGAUCENJA_OUT_2_CHANNEL     (2)
#define AI_MODELSTROJNEGAUCENJA_OUT_2_SIZE        (1 * 3 * 2)
#define AI_MODELSTROJNEGAUCENJA_OUT_2_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_MODELSTROJNEGAUCENJA_N_NODES (3)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup modelstrojnegaucenja
...
AI_DEPRECATED
AI_API_ENTRY
ai_bool ai_modelstrojnegaucenja_get_info(
 ...
 * @ref ai_modelstrojnegaucenja_create. Both the activations memory buffer 
 ...
 * using @ref ai_modelstrojnegaucenja_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_error ai_modelstrojnegaucenja_create_and_init(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_modelstrojnegaucenja_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_modelstrojnegaucenja_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MODELSTROJNEGAUCENJA_*
 * defines into file @ref modelstrojnegaucenja.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_modelstrojnegaucenja_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_MODELSTROJNEGAUCENJA_H */
