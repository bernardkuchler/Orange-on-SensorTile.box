...
AI_ALIGNED(32)
static uint8_t pool0[AI_MODELSTROJNEGAUCENJA_DATA_ACTIVATION_1_SIZE];
...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_MODELSTROJNEGAUCENJA_MODEL_NAME,
        .config = AI_MODELSTROJNEGAUCENJA_DATA_CONFIG,
        .ai_get_report = ai_modelstrojnegaucenja_get_report,
        .ai_create = ai_modelstrojnegaucenja_create,
        .ai_destroy = ai_modelstrojnegaucenja_destroy,
        .ai_get_error = ai_modelstrojnegaucenja_get_error,
        .ai_init = ai_modelstrojnegaucenja_init,
        .ai_run = ai_modelstrojnegaucenja_run,
        .ai_forward = ai_modelstrojnegaucenja_forward,
        .ai_data_params_get = ai_modelstrojnegaucenja_data_params_get,
