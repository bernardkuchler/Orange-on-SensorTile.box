---
pagetitle: Release Notes for LSM6DSL Component
lang: en
...
<center>
# Release Notes for LSM6DSL Component Driver
...
<label for="collapse-section14" aria-hidden="true">V5.5.0 / 31-October-2022</label>
<div>
...
<label for="collapse-section13" aria-hidden="true">V5.4.0 / 23-March-2022</label>
<div>
...
<label for="collapse-section12" aria-hidden="true">V5.3.1 / 21-April-2021</label>
<div>
...
<label for="collapse-section11" aria-hidden="true">V5.3.0 / 03-March-2021</label>
<div>
...
<label for="collapse-section10" aria-hidden="true">V5.2.3 / 13-November-2020</label>
<div>
...
<label for="collapse-section9" aria-hidden="true">V5.2.2 / 11-October-2019</label>
<div>
...
<label for="collapse-section8" aria-hidden="true">V5.2.1 / 18-June-2019</label>
<div>
...
<label for="collapse-section7" aria-hidden="true">V5.2.0 / 28-May-2019</label>
<div>
...
<label for="collapse-section6" aria-hidden="true">V5.1.0 / 31-January-2019</label>
<div>
...
- Update PID files
- Add inactivity detection support
...
- Add support to hardware multiple events
...
::: {.columns}
::: {.column width="95%"}
For complete documentation on LSM6DSL,
visit:
[LSM6DSL](https://www.st.com/content/st_com/en/products/mems-and-sensors/inemo-inertial-modules/lsm6dsl.html)
:::
::: {.column width="5%"}
