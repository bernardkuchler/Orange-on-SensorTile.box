...
S_SRCS += \
F:/FRI_novSSD/Diploma/Diploma-GitHub/AlgoBuilder/Zajem_podatkov-Jakost_gibanja/Projekt/Project/CubeIDE/STM32L4R9ZI-SensorTile.box/startup_stm32l4r9xx.s 

C_SRCS += \
F:/FRI_novSSD/Diploma/Diploma-GitHub/AlgoBuilder/Zajem_podatkov-Jakost_gibanja/Projekt/Project/CubeIDE/STM32L4R9ZI-SensorTile.box/syscalls.c 
...
Example/SW4STM32/startup_stm32l4r9xx.o: F:/FRI_novSSD/Diploma/Diploma-GitHub/AlgoBuilder/Zajem_podatkov-Jakost_gibanja/Projekt/Project/CubeIDE/STM32L4R9ZI-SensorTile.box/startup_stm32l4r9xx.s Example/SW4STM32/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -c -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@"  -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -mthumb -o "$@" "$<"
Example/SW4STM32/syscalls.o: F:/FRI_novSSD/Diploma/Diploma-GitHub/AlgoBuilder/Zajem_podatkov-Jakost_gibanja/Projekt/Project/CubeIDE/STM32L4R9ZI-SensorTile.box/syscalls.c Example/SW4STM32/subdir.mk
